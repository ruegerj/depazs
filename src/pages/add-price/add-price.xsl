                    ...
                    <div class="w3-container w3-text-white">
                        <form class="w3-container" action="/api/addEnergyPrice" method="post">
                            ...
                            <label for="plantName">Plant</label>
                                <select required="true" class="w3-input" name="plantName" id="plantName">
                                    <xsl:apply-templates
                            ...
                            <p>
                                ...
                                <select required="true" class="w3-input" name="energyType" id="energyType-input">
                            ...
                            <p>
                                ...
                                <input required="true" class="w3-input" type="date" name="date" id="date-input"
                                placeholder="new date" />
                            </p>
                            <p>
                                <label for="price-input">Price</label>
                                <input required="true" class="w3-input" type="number" name="price" id="price-input"
