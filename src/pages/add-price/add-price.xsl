            ...
            <body>
                ...
                <div class="w3-top">
                    <div class="w3-white w3-xlarge">
                        <div class="w3-button w3-padding-16 w3-left w3-text-white" style="background-color: #323232;
                        width: 120px;" onclick="w3_open()">☰</div>
                        <div class="w3-padding-16 w3-text-white" style="background-color: #323232;">&#xA0;DEPAZS</div>
                    </div>
                </div>

                <h1 class="w3-container w3-text-white w3-jumbo" style="margin-top: 80px"><b>Add Price</b></h1>
                <div class="w3-card-4 w3-round-medium w3-third w3-display-middle" style="position: relative; top: 200px; margin-top: 20px">
